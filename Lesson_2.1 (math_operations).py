...
a = 10
print('a = 10', a)
print('Правда ли, что a > (больше) 100: ', a > 100)
print('Правда ли, что a < (меньше) 100: ', a < 100)
print('Правда ли, что a <= (меньше или равно) 100: ', a <= 100)
print('Правда ли, что a >= (больше или равно) 100: ', a >= 100)
print('Правда ли, что a == (сравнение равно ли) 100: ', a == 100)
print('Правда ли, что a != (не равно) 100: ', a != 100)
# Примечание: написание "=>" или "=<" и print(a = 100) будет ошибкой синтаксиса
